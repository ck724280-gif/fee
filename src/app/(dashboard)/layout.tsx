  ...
  useEffect(() => {
    fetch('/api/auth/me')
      ...
      .then((data) => {
        ...
        // If Super Admin has 0 organizations and is not impersonating, send them to Super Admin console
        if (data.user.isSuperAdmin && !data.currentOrganization && !data.user.isImpersonating) {
